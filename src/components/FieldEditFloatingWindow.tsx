...
const DEFAULT_WINDOW_WIDTH = 268;
const DEFAULT_WINDOW_HEIGHT = 620;
const MIN_WINDOW_WIDTH = 236;
...
function getNearbyWindowPosition(
  ...
  const candidates = [
    {
      x: fieldRect.right + FIELD_WINDOW_GAP,
      y: verticalAlign,
    },
    {
      x: fieldRect.left - size.width - FIELD_WINDOW_GAP,
      y: verticalAlign,
    },
    {
      x: horizontalAlign,
      y: fieldRect.bottom + FIELD_WINDOW_GAP,
    },
    {
      x: horizontalAlign,
      y: fieldRect.top - size.height - FIELD_WINDOW_GAP,
    },
  ];
      ...
      const nextSize = clampWindowSize(
        {
          ...
          height: dragState.originHeight + dy,
        },
        viewport,
      );
    ...
    >
      ...
      >
        <FieldEditPanel
          ...
          onResetPosition={() => setWindowPosition(getDefaultWindowPosition(viewport, windowSize))}
        />
      </div>
