...
import { humanizeAgentError } from '../lib/agentApiClient';
import {
  INPUT_STYLE,
  LABEL,
  OVERLAY_CARD,
...
import { getStatusTone, summarizeActiveProvider, summarizeProvider } from '../lib/agentPanelHelpers';
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12, marginBottom: 14 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5 }}>
              <div style={PANEL_ACCENT_BAR('#5878ad')} />
              <span style={PANEL_SECTION_TITLE}>
                LPC Agent Settings
              </span>
            </div>
        ...
        <div style={{ display: 'grid', gap: 14 }}>
          <div style={{ display: 'grid', gap: 10, padding: '12px 12px', borderRadius: 14, background: 'rgba(248,251,254,0.72)', border: '1px solid rgba(166,184,198,0.18)' }}>
